...
/* for ConWeave Table */
#define CONWEAVE_HASH_WIDTH (16)  // maximum 16 bits
...
/** CONWEAVE: PARAMETERS */
const timestamp_t CONWEAVE_MAX_TIMESTAMP = 0;  // 2**31 - 1

const timestamp_t CONWEAVE_TX_EXPIRED_TS = 0;
const timestamp_t CONWEAVE_TX_ECN_PORT_TS = 0;
const timestamp_t CONWEAVE_TX_REPLY_TIMEOUT_EXTENSION_TS = 0;
const timestamp_t CONWEAVE_TX_STOP_REROUTING_TS = 0;

const timestamp_t CONWEAVE_RX_DEFAULT_WAITING_TIME = 0;
const timestamp_t CONWEAVE_RX_BASE_WAITING_TIME = 0;
const timestamp_t CONWEAVE_RX_ADJUST_TS_TAIL_WRAP = 0;           
const timestamp_t CONWEAVE_RX_ADJUST_TS_TAIL_WRAP_WITH_BASE = 0; 
